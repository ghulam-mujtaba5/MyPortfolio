...
const Scratchpad = () => {
    ...
    const handleSave = async () => {
        ...
        const body = isUpdating ? { id: editingNoteId, content: currentNote } : { content: currentNote };
        ...
        <div className={styles.widgetCard}>
            ...
            <div className={styles.scratchpadInputContainer}>
                ...
                <div className={styles.scratchpadActions}>
                    {editingNoteId && (
                        <button onClick={handleCancelEdit} className={`${styles.scratchpadButton} ${styles.cancelButton}`}>
                            Cancel
                        </button>
                    )}
                ...
                {notes.map(note => (
                    <li key={note._id} className={styles.noteItem}>
                        ...
                        <div className={styles.noteActions}>
                            <button onClick={() => handleEdit(note)} className={styles.noteActionButton}>
                                <Icon name="edit" />
                            </button>
                            <button onClick={() => handleDelete(note._id)} className={styles.noteActionButton}>
                                <Icon name="trash" />
                            </button>
                        </div>
                    </li>
