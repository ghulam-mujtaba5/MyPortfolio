...
const BadgeScroll = ({
  ...
  const badgeData = [
    ...
    },
    {
      ...
      description:
        "Google Cybersecurity Professional Certificate v2 via Credly.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Google Project Management Professional Certificate via Credly.",
    },
    {
...

    {
      ...
      description:
        "Microsoft Office Specialist Word Associate Office 2019 Certificate via Credly.",
    },
    {
    ...
    >
      ...
      >
        <div className={commonStyles.badgeWrapper}>
          {badgeData.concat(badgeData).map(
            (
              badge,
              index, // Duplicating the badgeData array
            ) => (
