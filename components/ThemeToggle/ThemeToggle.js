  ...
  return (
    ...
    >
      ...
      <span className={common.iconWrap} aria-hidden>
        {/* Sun (light) */}
        <svg className={common.sunIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          <defs>
          ...
          <circle cx="12" cy="12" r="4.25" fill="url(#tg-sun-grad)" stroke="currentColor" strokeWidth="1.2"/>
          <path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5.64 5.64 4.22 4.22M19.78 19.78l-1.42-1.42M18.36 5.64l1.42-1.42M5.64 18.36 4.22 19.78" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
        </svg>
        {/* Moon (dark) */}
        <svg className={common.moonIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          <defs>
          ...
          <path d="M21 12.79A9 9 0 1 1 11.21 3 7.5 7.5 0 0 0 21 12.79Z" fill="url(#tg-moon-grad)" stroke="currentColor" strokeWidth="1.2"/>
