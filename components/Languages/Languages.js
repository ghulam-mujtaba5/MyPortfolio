...
const Frame = () => {
  ...
  return (
    ...
    >
      <h2 id="languages-title" className={commonStyles.title}>
        Languages
      </h2>
      <div
        className={`${commonStyles.iconContainer} ${isVisible ? commonStyles.animate : ""}`}
      >
        <Image
          className={`${commonStyles.icon} ${isVisible ? commonStyles.animate : ""}`}
        ...
        <Image
          ...
          src="/javscript icon.svg"
          width={48}
          height={48}
        />
        <Image
          className={`${commonStyles.icon} ${isVisible ? commonStyles.animate : ""}`}
          alt="HTML markup language"
          src="/html icon.svg"
          width={48}
          height={48}
        />
