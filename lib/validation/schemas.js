...
export const projectSchema = z.object({
  ...
  status: z.enum(['In Progress', 'Completed', 'Archived']).optional().default('In Progress'),
  links: z.object({
...
export const articleSchema = z.object({
  ...
  coverImageAlt: z.string().trim().max(125, 'Alt text should not exceed 125 characters.').optional(),
