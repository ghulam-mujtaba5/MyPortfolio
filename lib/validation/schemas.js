...
export const projectSchema = z.object({
  ...
  image: z
    ...
    .optional(),
  // Gallery images array for project showcase
  gallery: z
    .array(
      z.object({
        url: z.string().refine((v) => isLooseImageUrl(v), {
          message: "Invalid URL for gallery image.",
        }),
        caption: z.string().trim().max(200).optional().default(""),
        alt: z.string().trim().max(125).optional().default(""),
    ...
    .optional()
    .default([]),
  // Controls how the project image fits in its box
  imageFit: z
    .enum(["contain", "cover", "fill", "none", "scale-down"]) // matches CSS object-fit
    .optional(),
...
export const articleSchema = z.object({
  ...
  coverImage: z
    ...
    .optional(),
  // Controls how the article cover image fits in its box
  coverImageFit: z
    .enum(["contain", "cover", "fill", "none", "scale-down"]) // matches CSS object-fit
    .optional(),
  coverImageAlt: z
  ...
  ogImage: z
    ...
    .optional(),
  // Optional CTA rendered at the end of the article — internal path or full URL
