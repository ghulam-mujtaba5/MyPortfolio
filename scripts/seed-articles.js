...
const articlesToSeed = [
  {
    ...
    excerpt: 'A practical guide to structuring, theming, and optimizing a personal portfolio using Next.js 15 and a custom CMS.',
    content:
  ...
  },
  {
    ...
    excerpt: 'Integrate a modern, theme-aware rich text editor (Tiptap) into your Next.js admin panel with SSR-safe configuration.',
    content:
  ...
  },
  {
    ...
    excerpt: 'How to migrate hardcoded project cards into a MongoDB collection and manage them through a secure admin panel.',
    content:
