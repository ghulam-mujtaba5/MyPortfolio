## 2026-08-22T20:27:55Z
You are teamwork_preview_test_writer_1.
Your working directory is: e:\MyPortfolio\.agents\teamwork_preview_test_writer_1/
...
Your mission:
Build an automated, requirement-driven E2E verification test suite at `scripts/verify-seo-performance.js` to rigorously test all SEO, GEO, AIO, Usability, Schema, and Performance requirements across all 8 canonical routes (`/`, `/about`, `/projects`, `/services`, `/insights`, `/contact`, `/uses`, `/privacy-policy`).
...
- Execute `node scripts/verify-seo-performance.js` to test the baseline.
- Create `e:\MyPortfolio\TEST_READY.md` summarizing the runner command, tier breakdown, and test counts.
- Maintain progress in `e:\MyPortfolio\.agents\teamwork_preview_test_writer_1/progress.md`.
- Write your completion report to `e:\MyPortfolio\.agents\teamwork_preview_test_writer_1/handoff.md` and send a completion message to the parent orchestrator.
